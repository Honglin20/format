"""
Quantized vector operations — OpQuantConfig-driven equivalents of mx/vector_ops.py.
...
These are building blocks for Norm operators (BatchNorm, LayerNorm, GroupNorm)
and other non-matmul operators that need per-step quantization.
"""
import numpy as np
import torch
