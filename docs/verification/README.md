...
| Layer 4 | Session + Viz：Session / resolve_config / viz contracts | 013-016 |

> **Note**: Layer 4 derivation docs are API contract documents, not numerical derivations. They describe the protocol, config, session execution, and visualization interfaces and verify them through integration tests.
